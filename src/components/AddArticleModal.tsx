...
import { X, FileText, AlertCircle, CheckCircle, Clock, Lock, ShieldCheck } from 'lucide-react';
...
export default function AddArticleModal({ language, onClose, onAdd, existingCategories }: AddArticleModalProps) {
